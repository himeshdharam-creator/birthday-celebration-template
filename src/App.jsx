    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Dhruwii</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Dhruwii's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>From Himesh with all my love 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Himesh 💖</h2>
          <p className="final-subtitle">With all my love ✨</p>
        </section>
      </div>
